              ...
              <el-form
                ...
                <el-form-item prop="verify_code">
                  <el-input
                    ...
                    placeholder="验证码">
                    <i slot="prepend" class="fa fa-credit-card"></i>
                  </el-input>
                </el-form-item>
                <el-button size="default" :loading="btnLoading" @click="submit" type="primary"
                           class="button-login">
                  重置密码
                </el-button>
              </el-form>
...
import { resetPwd } from '@api/aries/auth'
