...
部署了最新版本 `Aries` 的小伙伴请注意一下，需要进入后台管理的 `系统/设置/网站设置`，将**静态资源根路径**修改为最新版本：[https://gcore.jsdelivr.net/gh/zhaoyangkun/aries](https://gcore.jsdelivr.net/gh/zhaoyangkun/aries)
